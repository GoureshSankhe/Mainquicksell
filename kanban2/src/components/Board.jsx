...
const Board = ({ groupedTickets, selectedGroup, selectedSort, users, addNewTicket }) => {
        ...
        <div key={groupValue} className="board-column">
          <div className='d-flex justify-content-between align-items-center'>
            ...
            <div className="d-flex justify-content-center align-items-center">
              <button type='button' className='btn btn-light px-2 text-body-tertiary'><IoMdAdd onClick={() => addNewTicket(groupValue, 'New Ticket', 'Todo', '', 0)} /></button>
